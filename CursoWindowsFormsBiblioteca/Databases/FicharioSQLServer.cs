    ...
    public class FicharioSQLServer
    {
        ...
        public FicharioSQLServer(string Tabela)
        {
            ...
            try
            {
                ...
                tabela = Tabela;
                mensagem = "Conexao efetuada ";

            }
            catch (Exception ex)
            {
                status = false;
                mensagem = "Conexao com erro a Tabela: " + ex.Message;
            }
        }
        ...
        public string Buscar(string Id)
        {
            ...
            try
            {
                ...
                {
                    status = false;
                    mensagem = "Erro ao buscar o conteúdo do identificador: " + Id;
                }
            }
            catch (Exception ex)
            {
        ...
        public List<string> BuscarTodos()
        {
            ...
            try
            {
                ...
                {
                    status = false;
                    mensagem = "Nao ha registros na base ";
                }
            }
            catch (Exception ex)
            {
        ...
        public void Apagar(string Id)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    // DELETE FROM CLIENTES WHERE ID = '000001'
                    SQL = "DELETE FROM " + tabela + " WHERE ID = '" + Id + "'";
                    db.SQLCommand(SQL);
                    status = true;
                    mensagem = "Exclusao efetuada com sucesso. Identificador: " + Id;
                }
                else
                {
                    status = false;
        ...
        public void Alterar(string Id, string jsonUnit)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    db.SQLCommand(SQL);
                    status = true;
                    mensagem = "Alteracao efetuada com sucesso. Identificador: " + Id;
                }
                else
                {
                    status = false;
